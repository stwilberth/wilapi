    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-4">Sistema de gestión integral para empresas turísticas y hoteleras en Costa Rica. Optimice sus operaciones, mejore la experiencia de sus clientes y aumente su visibilidad en línea.</p>
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-4">Servicios</h3>
                <ul class="space-y-2">
                    <li>
                        <a href="/services#tours" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Gestión de Tours</a>
                    </li>
                    <li>
                        <a href="/services#rooms" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Gestión de Alojamientos</a>
                    </li>
                    <li>
                        <a href="/services#products" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Catálogo de Productos</a>
                    </li>
                    <li>
                        <a href="/services#analytics" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Análisis y Reportes</a>
                    </li>
                </ul>
            </div>
            <div>
